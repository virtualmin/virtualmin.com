...
Newly purchased products at *Virtualmin.com* are available immediately on [My Account ⇾ Dashboard](/account/) page. Install scripts for supported platforms are provided, as well as serial number and license keys for upgrading our open source products to Professional versions or downloading individual components from our software repository.
